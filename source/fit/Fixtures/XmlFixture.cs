...
namespace fit.Fixtures {
	...
	public class XmlFixture: UnnamedCollectionFixtureBase {
        ...
        protected override ListMatchStrategy MatchStrategy {
            get {return new XmlMatchStrategy(Processor);}
        }

        private class XmlMatchStrategy: CellMatcher, ListMatchStrategy {
            public XmlMatchStrategy(CellProcessor processor) : base(processor) {}
